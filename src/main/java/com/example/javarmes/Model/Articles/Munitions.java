...
public class Munitions extends Article {
    ...
    public Munitions(String identification, String categorie, String nom, double prix_unique,int quantite, double calibre,boolean reduction, double prix_vrac, int nb_vente) {
    ...
    public String toString(){
        return '\''+"{"+ "identification= " + identification +'\''+ ", categorie= "+categorie+ '\''
                + ", nom= "+nom + '\''+ ", prix unique= "+ prix_unique + '\''+ ", quantite= "+quantite + '\''+ ", calibre= "+calibre + ", reduction= "+reduction + ", prix_vrac= "+prix_vrac + ", nombre de ventes = "+ nb_vente + '}' + '\'';
    }
}
